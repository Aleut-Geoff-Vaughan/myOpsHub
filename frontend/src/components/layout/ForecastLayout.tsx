  ...
  const navigationGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { name: 'My Forecasts', path: '/forecast/my-forecasts', icon: icons.myForecasts, roles: [AppRole.ProjectManager, AppRole.ResourceManager, AppRole.TeamLead] },
      ],
    },
    {
      name: 'Projects',
      items: [
        { name: 'All Projects', path: '/forecast/projects', icon: icons.projects, roles: [AppRole.ProjectManager, AppRole.ResourceManager, AppRole.TenantAdmin, AppRole.SysAdmin, AppRole.Executive] },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Versions', path: '/forecast/versions', icon: icons.versions, roles: [AppRole.ProjectManager, AppRole.ResourceManager, AppRole.TenantAdmin, AppRole.SysAdmin, AppRole.Executive] },
      ],
    },
    {
      name: 'Administration',
