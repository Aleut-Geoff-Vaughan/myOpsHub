...
namespace MyScheduling.Infrastructure.Migrations
{
    ...
    [Migration("20251119142832_AddMultiTenantUserManagement")]
    partial class AddMultiTenantUserManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AleutStaffing.Core.Entities.TenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AleutStaffing.Core.Entities.User", b =>
                {
                    b.HasOne("AleutStaffing.Core.Entities.Tenant", null)
                        .WithMany("Users")
                        .HasForeignKey("TenantId")
